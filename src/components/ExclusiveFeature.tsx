...
const ExclusiveFeature = () => {
    return (
        <div>
            <h1 className="mb-4 text-black md:text-2xl">Course Exclusive Feature
            </h1>
      ...
      <div className="flex flex-col md:flex-row items-start gap-4">
        <div className="flex-1 space-y-2">
          <h3 className="text-base font-semibold text-gray-800">ভিডিও লেকচার</h3>
          <ul className="text-sm text-gray-700 space-y-1">
            <li>✔️ IELTS Academic ও General Training নিয়ে আলোচনা</li>
            <li>✔️ Reading, Writing, Listening ও Speaking এর Overview & Format</li>
